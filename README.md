...
[![版本](https://img.shields.io/badge/version-2.0.0-green)](https://github.com/HelloThreeLiu/ResearchWorkbench/releases)
...
| 文件 | 说明 |
| --- | --- |
| `格致科研工作台-x.y.z-x64.exe` | NSIS 安装包（推荐），支持自定义安装目录、创建桌面快捷方式 |
| `格致科研工作台-x.y.z-x64.zip` | 便携版，解压即用 |
